...
'fam_bio' : f'When I am not working I spend most of my free time with my beautiful wife Ashley and my 3 amazing children Olivia ({olivia_age_clean}), Bennett ({bennett_age_clean}), and Declan ({declan_age_clean}). Olivia raised her second hog for 4-h this year and is planning her third, Bennett is currently interested in all manner of sports and is dynamite on the soccer field, and Baby Declan’s stoicism continues to teach us how to the world is meant to be experienced, lessons I pay for in diaper changes and lack of sleep. My wife has her bachelors in health and human performance and is a runner, hiker, yogi, and an everlasting support system for the entire family.'}